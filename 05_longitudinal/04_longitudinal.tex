...
\begin{frame}{Visualization of individual data}
  \begin{center}
      \includegraphics[scale=.4]{figures/sleep_subjects}
  \end{center}
\end{frame}
...
\begin{frame}{Visualization of individual data}
  \begin{center}
      \includegraphics[scale=.4]{figures/sleep_random_intercept}
  \end{center}
\end{frame}
...
\begin{frame}{Visualization of individual data}
  \begin{center}
      \includegraphics[scale=.4]{figures/sleep_random_slope}
  \end{center}
\end{frame}
...
\begin{frame}{Shrinkage}
  \begin{center}
    \includegraphics[scale=.5]{figures/sleep_shrinkage}
  \end{center}
\end{frame}
