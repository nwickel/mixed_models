...
# setwd("C:/Users/nwickelmaier/Nextcloud/Documents/teaching/iwm/mixed_models/slides/05_repeated_measures/")
...
# aggregated data
pdf("../figures/hdrs-box.pdf", height = 3.375, width = 3.375, pointsize = 10)
