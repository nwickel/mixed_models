...
* Create a data frame with variables \texttt{id}, \texttt{group} and
  \texttt{score}. $x$ and $y$ are your score values.
...
```{r ex02.3, results = "hide", class.source = "fold-hide"}
x   <- rnorm(100, mean = 1)
y   <- rnorm(100, mean = 2)
...
```{r ex02.4, results = "hide", class.source = "fold-hide", fig.show = "hide"}
data(cars)
