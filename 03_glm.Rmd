...
```{r ex03.1, results = "hide", class.source = "fold-hide", fig.show = "hide"}
...
```{r ex03.2, results = "hide", class.source = "fold-hide", fig.show = "hide"}
newx <- seq(37, 43, .1)
...
```{r ex03.3, results = "hide", class.source = "fold-hide", fig.show = "hide"}
# Load data set
