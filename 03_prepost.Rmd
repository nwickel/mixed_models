...
```{r ex04.1, echo = FALSE}
dat <- read.table("slides/03_prepost/ancova-data.txt", header = TRUE)
...
```{r ex04.5, echo = FALSE, fig.width = 3.375, fig.height = 3.375, fig.align = "center"}
...
```{r ex04.6, results = "hide", class.source = "fold-hide", fig.show = "hide"}
## Fit models
...
* Create a factor factor `condition` indicating a control group and two
